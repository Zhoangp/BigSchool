        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseModel_AspNetUsers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseModel_CategoryModel_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseModel_CategoryId",
                table: "CourseModel",
                column: "CategoryId");
            ...
            for (int i = 0; i < 7; i++)
            {
                CategoryModel categoryModel = cateFake.Generate();
